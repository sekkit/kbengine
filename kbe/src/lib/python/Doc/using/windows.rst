...
optimized ``.pyc`` files in a ZIP, and ``python3.dll``, ``python38.dll``,
...
name as the DLL (``python38._pth``) or the executable (``python._pth``) and
...
* If you are loading :file:`python3.dll` or :file:`python38.dll` in your own
